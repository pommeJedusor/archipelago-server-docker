...
```bash
docker run -v ./host.yaml:/archipelago/Archipelago/host.yaml -v ./Players/:/archipelago/Archipelago/Players/ -v ./custom_worlds:/archipelago/Archipelago/custom_worlds/ -v ./output:/archipelago/Archipelago/output/ -p 38281:38281 archipelago-server-test:latest
```
